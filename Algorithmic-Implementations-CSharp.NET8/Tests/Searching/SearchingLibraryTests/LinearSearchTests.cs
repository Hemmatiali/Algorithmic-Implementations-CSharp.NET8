...
{
    /// <summary>
    ///     Tests the linear search method with an array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the linear search method with a list.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the linear search method with a target not in the array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the linear search method with a target not in the list.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the linear search method with an empty array.
    /// </summary>
    [Fact]
    public void Search_EmptyArray_ReturnsMinusOne()
    {
        ...
        // Act
        int result = LinearSearch.Search(emptyArray, target);
    ...
    /// <summary>
    ///     Tests the linear search method with an empty list.
    /// </summary>
    [Fact]
    public void Search_EmptyList_ReturnsMinusOne()
    {
        ...
        // Act
        int result = LinearSearch.Search(emptyList, target);
    ...
    /// <summary>
    ///     Tests the linear search method with a single-element array.
    /// </summary>
    [Fact]
    public void Search_SingleElementArray_ReturnsCorrectIndex()
    {
        ...
        // Act
        int result = LinearSearch.Search(singleElementArray, target);
    ...
    /// <summary>
    ///     Tests the linear search method with a single-element list.
    /// </summary>
    [Fact]
    public void Search_SingleElementList_ReturnsCorrectIndex()
    {
        ...
        // Act
        int result = LinearSearch.Search(singleElementList, target);
