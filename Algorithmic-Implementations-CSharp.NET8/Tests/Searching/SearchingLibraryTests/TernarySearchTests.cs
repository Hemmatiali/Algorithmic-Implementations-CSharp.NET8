...
{
    /// <summary>
    ///     Tests the ternary search method with a sorted array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the ternary search method with a target not in the array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the ternary search method with an empty array.
    /// </summary>
    [Fact]
    public void Search_EmptyArray_ReturnsMinusOne()
    {
        ...
        // Act
        int result = TernarySearch.Search(emptyArray, target);
    ...
    /// <summary>
    ///     Tests the ternary search method with a single-element array.
    /// </summary>
    [Fact]
    public void Search_SingleElementArray_ReturnsCorrectIndex()
    {
        ...
        // Act
        int result = TernarySearch.Search(singleElementArray, target);
    ...
    /// <summary>
    ///     Tests the ternary search method with a target that is the first element.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the ternary search method with a target that is the last element.
    /// </summary>
    [Fact]
