...
{
    /// <summary>
    ///     Tests Gnome Sort with a random unsorted array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests Gnome Sort with an already sorted array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests Gnome Sort with a reverse sorted array.
    /// </summary>
    [Fact]
    public void Sort_ReverseSortedArray_ReturnsSortedArray()
    {
        ...
        // Act
        GnomeSort.Sort(reverseSortedArray);
    ...
    /// <summary>
    ///     Tests Gnome Sort with an array containing duplicates.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithDuplicates_ReturnsSortedArray()
    {
        ...
        // Act
        GnomeSort.Sort(arrayWithDuplicates);
    ...
    /// <summary>
    ///     Tests Gnome Sort with a single-element array.
    /// </summary>
    [Fact]
    public void Sort_SingleElementArray_ReturnsSameArray()
    {
        ...
        // Act
        GnomeSort.Sort(singleElementArray);
    ...
    /// <summary>
    ///     Tests Gnome Sort with an empty array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests Gnome Sort with an array where all elements are the same.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithSameElements_ReturnsSameArray()
    {
        ...
        // Act
        GnomeSort.Sort(arrayWithSameElements);
    ...
    /// <summary>
    ///     Tests Gnome Sort with negative numbers included.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithNegativeNumbers_ReturnsSortedArray()
    {
        ...
        // Act
        GnomeSort.Sort(arrayWithNegatives);
    ...
    /// <summary>
    ///     Tests Gnome Sort with very large and very small integers.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithLargeNumbers_ReturnsSortedArray()
    {
        ...
        // Act
        GnomeSort.Sort(arrayWithLargeNumbers);
    ...
    {
        // Act
        var ex = Record.Exception(() => GnomeSort.Sort(null!));
