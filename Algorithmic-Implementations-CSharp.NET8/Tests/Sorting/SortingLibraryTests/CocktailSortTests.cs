...
/// <summary>
///     Unit tests for the CocktailSort class.
/// </summary>
public class CocktailSortTests
{
    /// <summary>
    ///     Tests Cocktail Sort with a random unsorted array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests Cocktail Sort with an already sorted array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests Cocktail Sort with a reverse sorted array.
    /// </summary>
    [Fact]
    public void Sort_ReverseSortedArray_ReturnsSortedArray()
    {
        ...
        // Act
        CocktailSort.Sort(reverseSortedArray);
    ...
    /// <summary>
    ///     Tests Cocktail Sort with an array containing duplicates.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithDuplicates_ReturnsSortedArray()
    {
        ...
        // Act
        CocktailSort.Sort(arrayWithDuplicates);
    ...
    /// <summary>
    ///     Tests Cocktail Sort with a single-element array.
    /// </summary>
    [Fact]
    public void Sort_SingleElementArray_ReturnsSameArray()
    {
        ...
        // Act
        CocktailSort.Sort(singleElementArray);
    ...
    /// <summary>
    ///     Tests Cocktail Sort with an empty array.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests Cocktail Sort with an array where all elements are the same.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithSameElements_ReturnsSameArray()
    {
        ...
        // Act
        CocktailSort.Sort(arrayWithSameElements);
    ...
    /// <summary>
    ///     Tests Cocktail Sort with negative numbers included.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithNegativeNumbers_ReturnsSortedArray()
    {
        ...
        // Act
        CocktailSort.Sort(arrayWithNegatives);
    ...
    /// <summary>
    ///     Tests Cocktail Sort with very large and very small integers.
    /// </summary>
    [Fact]
    public void Sort_ArrayWithLargeNumbers_ReturnsSortedArray()
    {
        ...
        // Act
        CocktailSort.Sort(arrayWithLargeNumbers);
    ...
    {
        // Act
        var ex = Record.Exception(() => CocktailSort.Sort(null!));
